...
| Lazy Fix | ⚙️ Ops | [View prompt](prompts/lazy-fix.md) |
| Lazy Build | ⚙️ Ops | [View prompt](prompts/lazy-build.md) |
...
| lazy-waitlist | Other | [View prompt](prompts/lazy-waitlist.md) |
